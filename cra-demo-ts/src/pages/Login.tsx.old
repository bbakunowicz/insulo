...
const handleSubmit = (actions: any, username: string, password: string, 
  authDispatch: any, dispatchState: any, location: any, history: History<LocationState>) => (evt: React.FormEvent<HTMLFormElement>):void => {
    evt.preventDefault();
    ...
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate onSubmit={(e: React.FormEvent<HTMLFormElement>):void => handleSubmit(
              authActions, username, password, authDispatch, authStateDispatch, location, history)(e)} >
          <TextField
            variant="outlined"
            margin="normal"
            required
