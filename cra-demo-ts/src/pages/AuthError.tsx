...
import type {AuthErrorSeverity} from "insulo-route";
// #Localization(start)
...
export default function AuthError({authError, authErrorId, authErrorSeverity}:{authError: string, authErrorId?: string, 
