...
import {withAuth, authTypes} from 'insulo-route';
...
class LoginSuspense extends Component {

  render() {
    const {classes} = this.props;
    const {value: authConfig} = this.props.authContext;
...
LoginSuspense.propTypes = {
  classes: PropTypes.object.isRequired,
  authContext: PropTypes.object.isRequired
};

export default withStyles(styles)(withAuth(LoginSuspense));
